<?php include_once "_partials/header.php" ?>
	...
	<form id="add-form" class="col-sm-6" action="_inc/add-item.php" method="post">
		...
		<p class="form-group">
			<textarea class="form-control" name="message" id="text" rows="3" placeholder="What do you want to do?"></textarea>
		</p>
		<p class="form-group submit-button">
			<input class="btn-sm btn-danger" type="submit" value="Add">
		</p>
	</form>
